...
public class CommonTemplateController {
     ...
     * @return
     */
    @RequestMapping("/common/defineCommonTemplate")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping("/common/delCommonTemplate")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping("/common/updateCommonTemplate")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping("/common/getCommonTemplate")
    @ResponseBody
