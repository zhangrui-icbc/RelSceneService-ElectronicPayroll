...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/css/todo/client//summary.css" rel="stylesheet">
	</head>
	<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/todo/client/summary.js"  ></script>
