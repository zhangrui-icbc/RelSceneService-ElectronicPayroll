...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/todo/client/login.css">
	</head>
	<body>
	 <input type="hidden" id="contextPath" name="contextPath"  value="${pageContext.request.contextPath}"/>
		...
		<script src="${pageContext.request.contextPath}/js/todo/client/login.js"  ></script>
