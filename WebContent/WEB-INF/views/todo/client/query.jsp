...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/css/todo/client/query.css" rel="stylesheet">
	</head>
	<body>
	...
	<script type="text/javascript"  src="${pageContext.request.contextPath}/js/todo/client/query.js"  ></script>
