...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/css/salary/client/queryRe.css" rel="stylesheet">		
	</head>
	<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/salary/client/layer.js"  ></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/salary/client/queryRe.js"  ></script>
